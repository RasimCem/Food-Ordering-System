    ...
    <div class="w-full">
        ...
        <div class="relative">
            <img
                ...
                :src="require('../../../public/images/slider-img.jpg').default"
                alt=""
            />
            <div
                class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 "
            >
                <div class=" bg-yellow-300 rounded-full h-11 mt-5 w-64 hover:shadow-2xl z-1 ">
                    <svg
        ...
        <div class="cotainer  h-full  my-16 p-1 sm:p-5  rounded ">
            ...
            <div class="container border-2 my-4 border-yellow-300 p-3 sm:flex ">
                <div class="relative w-full sm:w-64  bg-red-500">
                    <img
                ...
                <div class="w-3/6 p-3 tracking-wide ">
                    ...
                    <p class="text-md cursor-pointer">Description....</p>
                    <p class="text-md cursor-pointer"><i>Chef: </i>Andre</p>
                    <small class="text-sm cursor-pointer hover:text-yellow-400"
